...
setversioning() {
    # For staging branch
    KERNELNAME="ElectroPerf-$LINUXVER-LTO-R-WIFI-X01BD-v2.3-$DATE"
...
gen_zip() {
	...
	cd AnyKernel3 || exit
	cp -af "$KERNEL_DIR"/init.ElectroSpectrum.rc init.spectrum.rc && sed -i "s/persist.spectrum.kernel.*/persist.spectrum.kernel ElectroPerf-LTO-R-WIFI-v2.3/g" init.spectrum.rc
